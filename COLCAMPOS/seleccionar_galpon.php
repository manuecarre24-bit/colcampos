...
<aside class="sidebar">
    ...
    <a href="registro_pagos.php?granja=<?php echo $granja; ?>" class="btn-side">💰 Pagos / Nómina</a>
    <a href="gestion_almacen.php?granja=<?php echo $granja; ?>" class="btn-side">📦 Almacén</a>
